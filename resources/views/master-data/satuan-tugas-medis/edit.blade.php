    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('satuan-tugas-medis.update',$satuan_tugas_medis->FS_KD_SAT_TUGAS)}}" method="POST">
                    @csrf
                    <div class="form-group">
                        ...
                        <input placeholder="masukkan kode tugas medis" type="text" class="form-control"
                            name="kd_satuan_tugas_medis" value="{{$satuan_tugas_medis->FS_KD_SAT_TUGAS}}" readonly>
                    </div>
                    <div class="form-group mt-2">
                        ...
                        <input placeholder="masukkan nama tugas medis" type="text" class="form-control"
                            name="nm_satuan_tugas_medis" value="{{$satuan_tugas_medis->FS_NM_SAT_TUGAS}}">
                    </div>
                    <div class="mt-2">
