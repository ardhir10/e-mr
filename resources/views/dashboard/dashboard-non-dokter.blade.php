                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <form action="">
                                    <div class="d-flex">
                                        ...
                                        <input type="text" name="date_from"
                                            class="form-control form-control-sm form-control flatpickr-input datepicker-basic"
                                            style="width: auto;" value="{{$request->date_from ?? date('d-m-Y')}}">
                                        &nbsp;
                                        <input type="text" name="date_to"
                                            class="form-control form-control-sm form-control flatpickr-input datepicker-basic"
                                            style="width: auto;" value="{{$request->date_to ?? date('d-m-Y')}}">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <!-- Card -->
                                <div class="card card-1 animate__animated  animate__fadeInUp" style="">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div class="">
                                                <span class="font-size-xs font-weight-bold text-card-d1">Pasien Rawat
                                                    Jalan & IGD</span>
                                                ...
                                                <small style="font-weight: 500;font-style: italic;opacity: 0.5;">Jumlah
                                                    pasien rawat jalan & IGD</small>
                                            </div>
                                            <img src="{{asset('assets/images/rawat-jalan-warna.png')}}" alt=""
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <h1 class="mt-1 font-weight-bold-flex align-items-center text-card-d2"
                                                    style="    font-size: 40px;font-weight: 500;">
                                                    {{ number_format(count($jml_pasien_baru), 0, ',', '.') }}
                                                </h1>
                                                <small style="font-weight: 500;font-style: italic;opacity: 0.5;">Jumlah
                                                    pasien rawat inap masuk baru</small>
                                            </div>
                                            <img src="{{asset('assets/images/ri2.png')}}" alt=""
                                                style="height:120px;width: auto;">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <!-- Card -->
                                <div class="card card-3 animate__animated  animate__fadeInUp" style="">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <small style="font-weight: 500;font-style: italic;opacity: 0.5;">Jumlah
                                                    pasien rawat inap terkini </small>
                                            </div>
                                            <img src="{{asset('assets/images/rawat-inap.png')}}" alt=""
                                                style="height:120px;width: auto;">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-12 col-sm-12">
                ...
                <div class="card animate__animated animate__fadeInUpBig" style="border-radius: 23px;">
                    <div class="card-header">
                        <span class="fw-bold font-size-xs card-title text-uppercase">Grafik Bulanan Pasian Rawat Jalan &
                            IGD</span>
                        <select id="chartBulanan" class="form-seelct form-control-sm" onchange="getData()"
                        ...
                        <span class="badge bg-info d-none" id="getDataLoading"
...
<script>
    ...
    async function getDataRi() {
        ...
        let data = await axios.post("{{route('api.dashboard-rawat-inap-non-dokter')}}", {
            "tahun": tahun
        });
