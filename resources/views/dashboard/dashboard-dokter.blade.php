                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <!-- Card -->
                                    <div class="card"
                                        style="min-height:150px;background: #8EAADC;color:black !important;border:1px solid black">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h6 class="font-size-xs ">Jml Pasien R.Jalan</h6>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <!-- Card -->
                                    <div class="card"
                                        style="min-height:150px;background: #315496;color:#ffffff !important;border:1px solid black">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h6 class="font-size-xs " style="color:#ffffff !important;">Verifikasi
                                                        Catatan Medis</h6>
                                                    <p class="mt-2 font-weight-bold mb-2 d-flex align-items-center"
                                                        style="    font-size:20px;font-weight: 500;color:#ffffff !important;">
                                                       {{count($jml_blm_verif)}} Catatan belum terverifikasi
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <!-- Card -->
                                    <div class="card"
                                        style="min-height:150px;background: #FFE699;color:#000000 !important;border:1px solid black">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
