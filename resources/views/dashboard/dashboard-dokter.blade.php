                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                ...
                                <div class="card card-2 animate__animated  animate__fadeInUp "
                                    style="min-height:150px;;color:#ffffff !important;border:1px solid black">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <span class="font-size-xs text-card-d1" >Verifikasi
                                                    Catatan Medis</span>
                                                <h1 class="mt-1 font-weight-bold  d-flex align-items-center text-card-d2"
                                                     >
                                                    {{count($jml_blm_verif)}}
                                                </h1>
                                                <small style="font-weight: 500;font-style: italic;opacity: 0.5;">Catatan belum terverifikasi</small>
                                            </div>
                                            <img src="{{asset('assets/images/catatan.png')}}" alt="" style="height: 120px;width: auto;">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                ...
                                <div class="card card-3 animate__animated  animate__fadeInUp"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <span class="font-size-xs text-card-d1" >Pasien
                                                    R.Inap Terkini</span>
                                                <h1 class="mt-1 font-weight-bold  d-flex align-items-center text-card-d2"
                                                    style="    font-size: 40px;font-weight: 500;">
                                                    {{ number_format(count($jml_pasien_ri), 0, ',', '.') }}
                                                </h1>
                                                <small style="font-weight: 500;font-style: italic;opacity: 0.5;">Jumlah pasien rawat inap</small>
