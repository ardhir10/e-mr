...
class CreateTarAsesmenDokterBidanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('TAR_ASESMEN_DOKTER_BIDAN', function (Blueprint $table) {
            $table->id('FN_ID');
            ...
            $table->json('FJ_RK')->nullable();
            $table->json('FJ_RP')->nullable();
            $table->json('FJ_RH')->nullable();
            $table->json('FJ_RPSL')->nullable();

            $table->json('FJ_DO')->nullable();

            // --- PEMERIKSAAAN FISIK
            $table->string('FS_PEMERIKSAAN_FISIK_TAMBAHAN')->nullable();
    ...
    {
        Schema::dropIfExists('TAR_ASESMEN_DOKTER_BIDAN');
    }
}
